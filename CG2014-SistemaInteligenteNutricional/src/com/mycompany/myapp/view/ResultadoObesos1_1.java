 ...
 */
public class ResultadoObesos1_1 extends Form implements Runnable{
    ...
    public ResultadoObesos1_1(String rec[], String nome, float imc)
    {
    ...
    public void paint(Graphics g)
    {
       ...
       for(int i = 27; i < recomendacoes.length; i++)
       {
            g.setColor(0x0000FF);
    ...
    private class TrataEventos implements ActionListener
    {
        ...
        { 
                ...
                {
                    new ResultadoObesos1(recomendacoes, nome, imc).show(); 
                }
        }
    }
