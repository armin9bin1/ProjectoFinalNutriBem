 ...
 */
public class ResultadoObesos2_2 extends Form implements Runnable{
    private Thread t;
    ...
    public ResultadoObesos2_2(String rec[],String nome, float imc)
    {
    ...
    private class TrataEventos implements ActionListener
    {
        ...
        { 
                ...
                {
                   new ResultadoObesos2(recomendacoes, nome, imc).show();
                }
        }
    }
}
