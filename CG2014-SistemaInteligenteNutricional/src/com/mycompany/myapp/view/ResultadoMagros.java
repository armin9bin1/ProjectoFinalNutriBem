...
public class ResultadoMagros extends Form implements Runnable{
    private Thread t;
    ...
    public ResultadoMagros(String rec[], String nome, float imc)
    {
    ...
    private class TrataEventos implements ActionListener
    {
        ...
        { 
                ...
                {
                   new ResultadoMagros1_1(recomendacoes,nome,imc).show();
                }
        }
    }
}
